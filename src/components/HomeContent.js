          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="main__title">
                ...
                <Link to="/add-item" class="main__title-link">
                  add item
                </Link>
              </div>
            </div>
                      ...
                      {movies
                        ...
                        .map((item, index) => (
                          <tr key={item._id}>
                            ...
                            <td>
                              <div class="main__table-text">{item.genre}</div>
                            </td>
                            <td>
                              <div class="main__table-text">{item.year}</div>
                            </td>
                            {/* <td>
              ...
              <div class="dashbox">
                <div class="dashbox__title">
                  ...
                  <div class="dashbox__wrap">
                    ...
                    <Link class="dashbox__more" to="/users">
                      View All
                    </Link>
                  </div>
                </div>
                      ...
                      {movies
                        ...
                        .map((item, index) => (
                          <tr>
                            ...
                            <td>
                              <div class="main__table-text">{item.cast}</div>
                            </td>
                            <td>
                              <div class="main__table-text">{item.year}</div>
                            </td>
